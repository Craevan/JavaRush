...
public class Solution {
    ...
    static LocalDateTime changeZone(LocalDateTime fromDateTime, ZoneId fromZone, ZoneId toZone) {
        ...
        ZonedDateTime zdt_First = ZonedDateTime.of(fromDateTime,fromZone);
        ZonedDateTime zdt_Result = zdt_First.withZoneSameInstant(toZone);

        return zdt_Result.toLocalDateTime();
    }
}
