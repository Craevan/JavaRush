...
public class CustomTree extends AbstractList<String> implements Cloneable, Serializable {
    ...
    private void setUpCollection(Entry<String> root) {
        queue = new ArrayList<>();
        childUtilMethod(root, queue);

    }

    private void childUtilMethod(Entry<String> root, ArrayList<Entry<String>> queue) {
     ...
     * инициализируется новый элемент Entry<String>, добавляется в коллекцию. После чего коллекция заново
     ...
     * from this collection with the iterators <tt>remove</tt> method.
     *
